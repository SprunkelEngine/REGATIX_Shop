...
$pk = (string)($cfg['variant']['primary_key'] ?? 'Artikelnummer');
  ...
  <div class="container">
    <div class="header">
      ...
      <div style="display:flex; gap:10px; flex-wrap:wrap; align-items:center">
        ...
        <a class="btn" href="index.php">Frontend</a>
       <!-- <a class="btn" href="../import.php?token=<?= h($cfg['security']['import_token'] ?? '') ?>">Import</a>-->
      ...
      <div class="card-b">
        <form method="post" style="display:flex; gap:10px; flex-wrap:wrap; align-items:flex-end">
          ...
          <div style="min-width:260px">
            <label>Produkt-Key (z.B. fachbodenregal)</label>
            <input name="new_product_key" placeholder="fachbodenregal" required value="">
          </div>
        ...
        <div class="card-b">
          ...
          <form method="post">
            ...
            <?php
              ...
              $keys = [
                'Ebenen','Material','Nennhöhe mm','Nenntiefe mm','Nennlänge mm','Gewicht kg',
                'lichte Breite mm','Achsmaß mm','ohne MwSt. €','mit MwSt. €','Verfügbarkeit'
              ];
              foreach ($keys as $k):
