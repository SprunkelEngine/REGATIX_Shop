...
if ($mode === 'offer') {
    ...
    // Für Offer berechnen wir keine Summen, aber wir können die Notiz trotzdem validieren (ohne Mindestwert-Logik würde es sonst "false" liefern).
    // Wir validieren hier pragmatisch mit grossItems=999999, damit min_gross nicht blockt (Offer ist Anfrage).
    if ($discountCode !== '') {
...
$phoneMain = trim((string)($kundendaten['ship_phone'] ?? ''));
